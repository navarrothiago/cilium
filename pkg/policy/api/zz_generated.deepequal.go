...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *Spiffe) DeepEqual(other *Spiffe) bool {
	if other == nil {
		return false
	}

	if ((in.PeerIDs != nil) && (other.PeerIDs != nil)) || ((in.PeerIDs == nil) != (other.PeerIDs == nil)) {
		in, other := &in.PeerIDs, &other.PeerIDs
		if other == nil {
			return false
		}
...
func (in *TLSContext) DeepEqual(other *TLSContext) bool {
	...
	if (in.Spiffe == nil) != (other.Spiffe == nil) {
		return false
	} else if in.Spiffe != nil {
		if !in.Spiffe.DeepEqual(other.Spiffe) {
			return false
		}
	}
