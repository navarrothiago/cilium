...
type EndpointProxy interface {
	...
	UpdateSVIDs(id identity.NumericIdentity, svids []*workload.X509SVID)
}
...
func (f *FakeEndpointProxy) UpdateSVIDs(id identity.NumericIdentity, svids []*workload.X509SVID) {}
